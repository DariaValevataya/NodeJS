...
var chunk_34EIGQR7_exports = {};
__export(chunk_34EIGQR7_exports, {
...
module.exports = __toCommonJS(chunk_34EIGQR7_exports);
...
function lintSchema({ schema }) {
  const lintResult = import_chunk_6WHJ22KZ.prismaSchemaWasm.lint(JSON.stringify(schema));
