...
var chunk_GGSJD54R_exports = {};
__export(chunk_GGSJD54R_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_GGSJD54R_exports);
...
var import_function = (0, import_chunk_FVJ3R4NJ.__toESM)((0, import_chunk_SR62DZRZ.require_function)());
var debug = (0, import_debug.default)("prisma:getDMMF");
var GetDmmfError = class extends Error {
  constructor(params) {
    const constructedErrorMessage = (0, import_chunk_5NQFDVEO.$)(params).with({ _tag: "parsed" }, ({ errorCode, message, reason }) => {
...
[Context: getDmmf]`;
    super((0, import_chunk_2YXLI6ET.addVersionDetailsToErrorMessage)(errorMessageWithContext));
    this.name = "GetDmmfError";
  }
};
async function getDMMF(options) {
  warnOnDeprecatedFeatureFlag(options.previewFeatures);
  const debugErrorType = (0, import_chunk_UZYFLJ47.createDebugErrorType)(debug, "getDmmfWasm");
  debug(`Using getDmmf Wasm`);
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_FQ7AWWIU.tryCatch2)(
      () => {
    ...
    (0, import_chunk_FQ7AWWIU.chainW2)((datamodel) => {
      return (0, import_function.pipe)(
        (0, import_chunk_FQ7AWWIU.tryCatch)(
          () => {
            ...
            const data = import_chunk_6WHJ22KZ.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
        ...
        (0, import_chunk_FQ7AWWIU.map)((result) => ({ result })),
        (0, import_chunk_FQ7AWWIU.chainW)(
          ({ result }) => (
  ...
  if ((0, import_chunk_FQ7AWWIU.isRight)(dmmfEither)) {
    debug("dmmf data retrieved without errors in getDmmf Wasm");
    const { right: data } = dmmfEither;
    return Promise.resolve(data);
  }
  const error = (0, import_chunk_5NQFDVEO.$)(dmmfEither.left).with({ type: "read-datamodel-path" }, (e) => {
    debugErrorType(e);
...
Datamodel path: "${e.datamodelPath}"`,
    ...
    if ((0, import_chunk_A4QWQE3W.isWasmPanic)(e.error)) {
      ...
      const panic = new import_chunk_A4QWQE3W.RustPanic(
        ...
        options.prismaPath,
        /* schema */
        (0, import_chunk_QKOL7AVL.schemaToStringDebug)(options.datamodel)
      );
      return panic;
    }
    const errorOutput = e.error.message;
    return new GetDmmfError((0, import_chunk_UZYFLJ47.parseQueryEngineError)({ errorOutput, reason: e.reason }));
