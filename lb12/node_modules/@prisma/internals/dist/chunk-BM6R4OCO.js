...
var chunk_BM6R4OCO_exports = {};
__export2(chunk_BM6R4OCO_exports, {
  sendPanic: () => sendPanic
});
module.exports = __toCommonJS2(chunk_BM6R4OCO_exports);
...
async function sendPanic({
  ...
  const schema = (0, import_chunk_5NQFDVEO.$)(error).with({ schemaPath: import_chunk_5NQFDVEO.N.not(import_chunk_5NQFDVEO.N.nullish) }, (err) => {
    return import_fs.default.readFileSync(err.schemaPath, "utf-8");
  }).with({ schema: import_chunk_5NQFDVEO.N.not(import_chunk_5NQFDVEO.N.nullish) }, (err) => err.schema).otherwise(() => void 0);
  const maskedSchema = schema ? (0, import_chunk_GXDHVUPK.maskSchema)(schema) : void 0;
  let dbVersion;
  if (error.area === "LIFT_CLI") {
    const getDatabaseVersionParams = (0, import_chunk_5NQFDVEO.$)({
      schema,
      introspectionUrl: error.introspectionUrl
    }).with({ schema: import_chunk_5NQFDVEO.N.not(void 0) }, ({ schema: schema2 }) => {
      return {
        datasource: {
          tag: "SchemaString",
          schema: schema2
    ...
    }).with({ introspectionUrl: import_chunk_5NQFDVEO.N.not(void 0) }, ({ introspectionUrl }) => {
      return {
        datasource: {
