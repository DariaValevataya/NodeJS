...
var chunk_A5WB4YTH_exports = {};
__export(chunk_A5WB4YTH_exports, {
...
module.exports = __toCommonJS(chunk_A5WB4YTH_exports);
...
var import_chunk_LT7P2ZUX = require("./chunk-LT7P2ZUX.js");
var import_chunk_VOAUNUTT = require("./chunk-VOAUNUTT.js");
var import_chunk_UHZ7GNWL = require("./chunk-UHZ7GNWL.js");
var import_chunk_QKOL7AVL = require("./chunk-QKOL7AVL.js");
var import_chunk_ESQ2WUBB = require("./chunk-ESQ2WUBB.js");
...
async function formatSchema({ schemaPath: schemaPath2, schema }, inputFormattingOptions) {
  ...
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_ESQ2WUBB.prismaSchemaWasm.debug_panic();
      },
  ...
  const { formattedSchema, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_LT7P2ZUX.lintSchema)({ schema: formattedSchema2 });
      return { formattedSchema: formattedSchema2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemaPath: schemaPath2, schema: schemaContent }
  );
  const lintWarnings = (0, import_chunk_LT7P2ZUX.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_ESQ2WUBB.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_VOAUNUTT.getConfig)({
    datamodel,
  ...
  const dmmf = await (0, import_chunk_UHZ7GNWL.getDMMF)({
    datamodel,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_UHZ7GNWL.getDMMF)({
            datamodel,
            datamodelPath: schemaPath,
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_VOAUNUTT.getConfig)({ datamodel: datamodel2, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_VOAUNUTT.resolveUrl)((0, import_chunk_VOAUNUTT.getEffectiveUrl)(config2.datasources[0]));
