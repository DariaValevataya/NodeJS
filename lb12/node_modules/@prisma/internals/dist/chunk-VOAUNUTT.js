...
var chunk_VOAUNUTT_exports = {};
__export(chunk_VOAUNUTT_exports, {
...
module.exports = __toCommonJS(chunk_VOAUNUTT_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_FQ7AWWIU.tryCatch)(
      () => {
        ...
        const data = import_chunk_ESQ2WUBB.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
