...
var chunk_LT7P2ZUX_exports = {};
__export(chunk_LT7P2ZUX_exports, {
...
module.exports = __toCommonJS(chunk_LT7P2ZUX_exports);
...
function lintSchema({ schema }) {
  const lintResult = import_chunk_ESQ2WUBB.prismaSchemaWasm.lint(JSON.stringify(schema));
