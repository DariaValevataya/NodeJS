...
var chunk_XU3VCWGX_exports = {};
__export(chunk_XU3VCWGX_exports, {
  handleLibraryLoadingErrors: () => handleLibraryLoadingErrors
});
module.exports = __toCommonJS(chunk_XU3VCWGX_exports);
...
function handleLibraryLoadingErrors(args) {
  ...
  const potentialReasonMessage = (0, import_chunk_5NQFDVEO.$)({ message: error.message, code: error.code }).with({ code: "ENOENT" }, () => `File does not exist.`).when(
