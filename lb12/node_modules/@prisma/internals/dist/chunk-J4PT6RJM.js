...
var chunk_J4PT6RJM_exports = {};
__export(chunk_J4PT6RJM_exports, {
  locateLocalCloudflareD1: () => locateLocalCloudflareD1
});
module.exports = __toCommonJS(chunk_J4PT6RJM_exports);
...
async function locateLocalCloudflareD1({ arg }) {
  ...
  if (d1Databases.length > 1) {
    const { originalArg, recommendedArg } = (0, import_chunk_5NQFDVEO.$)(arg).with("--to-local-d1", (originalArg2) => ({
