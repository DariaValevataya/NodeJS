...
var chunk_FJGMVLCI_exports = {};
__export(chunk_FJGMVLCI_exports, {
...
module.exports = __toCommonJS(chunk_FJGMVLCI_exports);
...
async function execaCommand({
  ...
  schemaEnginePath = schemaEnginePath || await (0, import_chunk_GJ2MHETC.resolveBinary)(import_fetch_engine.BinaryType.SchemaEngineBinary);
  try {
