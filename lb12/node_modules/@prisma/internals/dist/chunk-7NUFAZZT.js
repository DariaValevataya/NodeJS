...
var chunk_7NUFAZZT_exports = {};
__export(chunk_7NUFAZZT_exports, {
  getEngineVersion: () => getEngineVersion,
  safeGetEngineVersion: () => safeGetEngineVersion
});
module.exports = __toCommonJS(chunk_7NUFAZZT_exports);
...
async function getEngineVersion(enginePath, binaryName) {
  ...
  enginePath = await (0, import_chunk_GJ2MHETC.resolveBinary)(binaryName, enginePath);
  ...
  if (binaryName === import_fetch_engine.BinaryType.QueryEngineLibrary) {
    ...
    const QE = (0, import_chunk_TSN7DU5L.loadLibrary)(enginePath, platformInfo);
...
function safeGetEngineVersion(enginePath, binaryName) {
  return (0, import_chunk_FQ7AWWIU.tryCatch2)(
