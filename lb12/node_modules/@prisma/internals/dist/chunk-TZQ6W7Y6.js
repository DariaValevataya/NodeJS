...
var chunk_TZQ6W7Y6_exports = {};
__export(chunk_TZQ6W7Y6_exports, {
...
module.exports = __toCommonJS(chunk_TZQ6W7Y6_exports);
...
async function getConfig(options) {
  const debugErrorType = (0, import_chunk_UZYFLJ47.createDebugErrorType)(debug, "getConfigWasm");
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_FQ7AWWIU.tryCatch)(
      () => {
        ...
        const data = import_chunk_6WHJ22KZ.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
  ...
  if ((0, import_chunk_FQ7AWWIU.isRight)(configEither)) {
  ...
  const error = (0, import_chunk_5NQFDVEO.$)(configEither.left).with({ type: "wasm-error" }, (e) => {
    debugErrorType(e);
    ...
    return new GetConfigError((0, import_chunk_UZYFLJ47.parseQueryEngineError)({ errorOutput, reason: e.reason }));
  }).otherwise((e) => {
    debugErrorType(e);
