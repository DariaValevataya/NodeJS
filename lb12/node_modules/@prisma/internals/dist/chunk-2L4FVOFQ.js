...
var chunk_2L4FVOFQ_exports = {};
__export(chunk_2L4FVOFQ_exports, {
  getGitHubIssueUrl: () => getGitHubIssueUrl,
  wouldYouLikeToCreateANewIssue: () => wouldYouLikeToCreateANewIssue
});
module.exports = __toCommonJS(chunk_2L4FVOFQ_exports);
...
async function wouldYouLikeToCreateANewIssue(options) {
  const shouldCreateNewIssue = await (0, import_chunk_5NQFDVEO.$)(options.prompt).with(true, async () => {
