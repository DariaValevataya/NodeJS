...
var ExperimentalFlagError = class extends Error {
  constructor() {
    super(`Please provide the ${(0, import_chunk_F7KSWWYN.green)("--experimental")} flag to use this command.`);
  }
};
...
Please provide the ${(0, import_chunk_F7KSWWYN.green)("--preview-feature")} flag to use this command.`
    );
  }
};
...
Please provide the ${(0, import_chunk_F7KSWWYN.green)("--early-access")} flag to use this command.`
    );
  }
};
