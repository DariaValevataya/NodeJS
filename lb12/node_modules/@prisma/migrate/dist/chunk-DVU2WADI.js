...
var chunk_DVU2WADI_exports = {};
__export(chunk_DVU2WADI_exports, {
...
module.exports = __toCommonJS(chunk_DVU2WADI_exports);
...
var require_kill = (0, import_chunk_FVJ3R4NJ.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/kill.js"(exports, module2) {
    ...
    var onExit = (0, import_chunk_NS3ORO5H.require_signal_exit)();
...
var require_execa = (0, import_chunk_FVJ3R4NJ.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/index.js"(exports, module2) {
    ...
    var onetime = (0, import_chunk_NS3ORO5H.require_onetime)();
...
var require_has_yarn = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_p_try = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_pkg_up = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
async function verifySeedConfigAndReturnMessage(schemaPath) {
  ...
  let message = `${(0, import_chunk_F7KSWWYN.red)(
...
${(0, import_chunk_F7KSWWYN.green)(`${packageManager} ts-node typescript @types/node`)}
`;
    } else if (detected.sh) {
      message += `
\`\`\`
...
${(0, import_chunk_F7KSWWYN.bold)("TypeScript:")}
\`\`\`
"prisma": {
...
${(0, import_chunk_F7KSWWYN.bold)("JavaScript:")}
\`\`\`
"prisma": {
...
${(0, import_chunk_F7KSWWYN.bold)("Bash:")}
\`\`\`
"prisma": {
  "seed": "./prisma/seed.sh"
}
...
async function executeSeedCommand({
  ...
  process.stdout.write(`Running seed command \`${(0, import_chunk_F7KSWWYN.italic)(command)}\` ...
`);
  try {
    ...
    const e = _e;
    debug({ e });
    console.error((0, import_chunk_F7KSWWYN.bold)((0, import_chunk_F7KSWWYN.red)(`
An error occurred while running the seed command:`)));
    console.error((0, import_chunk_F7KSWWYN.red)(e.stderr || String(e)));
    return false;
  }
  return true;
}
...
async function legacyTsNodeScriptWarning() {
  ...
  if (scripts?.["ts-node"]) {
    import_internals.logger.warn(
      (0, import_chunk_F7KSWWYN.yellow)(`The "ts-node" script in the package.json is not used anymore since version 3.0 and can now be removed.`)
    );
  }
  return void 0;
}
...
var init_seed = (0, import_chunk_FVJ3R4NJ.__esm)({
  "src/utils/seed.ts"() {
    import_execa = (0, import_chunk_FVJ3R4NJ.__toESM)(require_execa());
    import_has_yarn = (0, import_chunk_FVJ3R4NJ.__toESM)(require_has_yarn());
    (0, import_chunk_F7KSWWYN.init_colors)();
    import_pkg_up = (0, import_chunk_FVJ3R4NJ.__toESM)(require_pkg_up());
