...
var chunk_N4SUUPKJ_exports = {};
__export(chunk_N4SUUPKJ_exports, {
  Migrate: () => Migrate,
  init_Migrate: () => init_Migrate
});
module.exports = __toCommonJS(chunk_N4SUUPKJ_exports);
...
var require_wrap_ansi = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_log_update = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var import_log_update, packageJson, Migrate;
var init_Migrate = (0, import_chunk_FVJ3R4NJ.__esm)({
  "src/Migrate.ts"() {
    (0, import_chunk_F7KSWWYN.init_colors)();
    import_log_update = (0, import_chunk_FVJ3R4NJ.__toESM)(require_log_update());
    ...
    Migrate = class {
      constructor(schemaPath, enabledPreviewFeatures) {
        if (schemaPath) {
          ...
          this.engine = new import_chunk_AYRKWF7U.SchemaEngine({
      ...
      async tryToRunGenerate() {
        ...
        (0, import_log_update.default)(`Running generate... ${(0, import_chunk_F7KSWWYN.dim)("(Use --skip-generate to skip the generators)")}`);
