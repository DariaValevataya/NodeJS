...
var chunk_AYRKWF7U_exports = {};
__export(chunk_AYRKWF7U_exports, {
  EngineError: () => EngineError,
  SchemaEngine: () => SchemaEngine,
  init_SchemaEngine: () => init_SchemaEngine
});
module.exports = __toCommonJS(chunk_AYRKWF7U_exports);
...
function serializePanic(log) {
  return `${(0, import_chunk_F7KSWWYN.red)((0, import_chunk_F7KSWWYN.bold)("Error in Schema engine.\nReason: "))}${log}
`;
}
var debugRpc, debugStderr, debugStdin, EngineError, messageId, SchemaEngine;
var init_SchemaEngine = (0, import_chunk_FVJ3R4NJ.__esm)({
  "src/SchemaEngine.ts"() {
    (0, import_chunk_F7KSWWYN.init_colors)();
    (0, import_chunk_ZNVXC2GC.init_byline)();
    (0, import_chunk_B6HAG5FE.init_handleViewsIO)();
      ...
      async introspect({
        ...
        try {
          ...
          if (views) {
            ...
            await (0, import_chunk_B6HAG5FE.handleViewsIO)({ views, schemaPath });
          }
...
${this.lastError?.backtrace ?? ""}`;
            ...
            (0, import_chunk_ZNVXC2GC.byline)(this.child.stderr).on("data", (msg) => {
            ...
            (0, import_chunk_ZNVXC2GC.byline)(this.child.stdout).on("data", (line) => {
...
${response.error.data?.message ?? ""}`;
                  ...
                  let message = `${(0, import_chunk_F7KSWWYN.red)(response.error.data.message)}
`;
                  if (response.error.data?.error_code) {
                    message = (0, import_chunk_F7KSWWYN.red)(`${response.error.data.error_code}
...
`) + message;
                  ...
                  reject(
                    new Error(
                      `${(0, import_chunk_F7KSWWYN.red)("Error in RPC")}
