...
var chunk_GTSP4NED_exports = {};
__export(chunk_GTSP4NED_exports, {
  DbSeed: () => DbSeed,
  init_DbSeed: () => init_DbSeed
});
module.exports = __toCommonJS(chunk_GTSP4NED_exports);
...
var require_arg = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var init_DbSeed = (0, import_chunk_FVJ3R4NJ.__esm)({
  "src/commands/DbSeed.ts"() {
    import_arg = (0, import_chunk_FVJ3R4NJ.__toESM)(require_arg());
...
${(0, import_chunk_F7KSWWYN.dim)("$")} prisma db seed -- --arg1 value1 --arg2 value2`);
          }
        ...
        if (!seedCommandFromPkgJson) {
          ...
          const message = await (0, import_chunk_DVU2WADI.verifySeedConfigAndReturnMessage)(schemaPath);
          if (message) {
        ...
        const successfulSeeding = await (0, import_chunk_DVU2WADI.executeSeedCommand)({ commandFromConfig: seedCommandFromPkgJson, extraArgs });
...
${(0, import_chunk_F7KSWWYN.bold)("Usage")}
  ...
  ${(0, import_chunk_F7KSWWYN.dim)("$")} prisma db seed [options]
