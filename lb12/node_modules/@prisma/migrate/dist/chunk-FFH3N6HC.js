...
var chunk_FFH3N6HC_exports = {};
__export(chunk_FFH3N6HC_exports, {
  DbExecute: () => DbExecute,
  init_DbExecute: () => init_DbExecute
});
module.exports = __toCommonJS(chunk_FFH3N6HC_exports);
...
var require_get_stdin = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var init_DbExecute = (0, import_chunk_FVJ3R4NJ.__esm)({
  "src/commands/DbExecute.ts"() {
    import_get_stdin = (0, import_chunk_FVJ3R4NJ.__toESM)(require_get_stdin());
...
${(0, import_chunk_F7KSWWYN.dim)("$")} prisma db execute [options]

${(0, import_chunk_F7KSWWYN.bold)("Options")}

-h, --help            Display this help message

${(0, import_chunk_F7KSWWYN.italic)("Datasource input, only 1 must be provided:")}
--url                 URL of the datasource to run the command on
--schema              Path to your Prisma schema file to take the datasource URL from

${(0, import_chunk_F7KSWWYN.italic)("Script input, only 1 must be provided:")}
...
See \`${(0, import_chunk_F7KSWWYN.green)((0, import_internals.getCommandWithExecutor)("prisma db execute -h"))}\``
          );
...
This command takes as input a datasource, using ${(0, import_chunk_F7KSWWYN.green)(`--url`)} or ${(0, import_chunk_F7KSWWYN.green)(`--schema`)} and a script, using ${(0, import_chunk_F7KSWWYN.green)(
      `--stdin`
    )} or ${(0, import_chunk_F7KSWWYN.green)(`--file`)}.
...
${(0, import_chunk_F7KSWWYN.italic)(`This command is currently not supported on MongoDB.`)}
